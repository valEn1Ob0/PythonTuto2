...
def cursos(curso):
    return 100 - dalto_cursos * 1000 // curso / 10
...
tiempo_vacio_removido_dalto = 100 - dalto_cursos * 1000 // crudo_dalto / 10
...
# diferencias si los cursos duraran 10 hs

print(f"ver 10 horas de este curso equivale ver {otros_cursos_promedio * 100 // dalto_cursos / 10} horas de otros cursos")
print(f"ver 10 horas de otros cursos equivale ver {dalto_cursos * 100 // otros_cursos_promedio / 10} horas de cursos de dalto")
print('................')